...
while (have_posts()) :
    ...
    $translation_services_partners_section = get_field('translation_services_partners_section');
    $price_perfect_section = get_field('price_perfect_section');
    $english_to_etc_translation_section = get_field('english_to_etc_translation_section');
    $translation_services_section = get_field('translation_services_section');
    $translators_section = get_field('translators_section');
    $pricing_plans_section = get_field('pricing_plans_section');
    $need_more_info = get_field('need_more_info');
    $where_to_start_section = get_field('where_to_start_section');
    $our_process_section = get_field('our_process_section');
    $etc_translation_services_section = get_field('etc_translation_services_section');
    $etc_translation_categories_section = get_field('etc_translation_categories_section');
    $quick_guide_to_etc_translation_section = get_field('quick_guide_to_etc_translation_section');
...
<style>
        ...
        <div class="home-main-hero languagesPage">
            ...
            <div class="HomeInnerContainer languagesPage">
                <div class="home-main-hero-left">
                    <p></p>
                    <p><?php echo __($hero_section)['main_heading'] ?></p>
                    <div style="margin-bottom: 16px">
                        <p></p>
                        <p></p>
                        <?php echo __($hero_section)['description'] ?>
                    </div>
                    <p></p>
                    <div class="buttons">
                        <a href="<?php echo __($hero_section)['order_button_link'] ?>">
                            <button class="btn"><?php echo get_default_content($hero_section['order_button_text'], "Order Online") ?></button>
                        </a>
                        <a href="<?php echo __($hero_section)['contact_button_link'] ?>">
                            <button class="white"><?php echo get_default_content($hero_section['contact_button_text'], "Contact Sales") ?></button>
                        </a>
                    </div>
                </div>
                <div class="lanagugePageMainMask" style="-webkit-mask-image: url('<?php echo get_template_directory_uri() ?>/Images/LanguagePageMask.png');
                mask-image: url('<?php echo get_template_directory_uri() ?>/Images/LanguagePageMask.png');
                -webkit-mask-repeat: no-repeat;
                mask-repeat: no-repeat; ">
                    <img class="hero-tree" src="<?php echo __($hero_section)['main_image'] ?>" alt="">
                </div>
            </div>
            <p class="bottomtext"><?php echo __($hero_section)['button_sub_heading'] ?></p>
        </div>
    <?php } ?>

    <?php if ($translation_services_partners_section['show_section'] == 1) { ?>
        <!-- ---------------------------------------------------------------------------------------------- -->
            ...
            <div class="main-sec">
                ...
                <div class="both-sliders">
                    <div id="top-row-partners" class="top-row-partners">
                        <?php
                        $post_ids = $translation_services_partners_section['partners_top_row'];
                        $args = array(
                    ...
                    <div id="bottom-row-partners" class="bottom-row-partners">
                        <?php
                        $post_ids = $translation_services_partners_section['partners_bottom_row'];
                        $args = array(
                            'post_type'      => 'ct-partner',
                            'post_status'    => 'publish',
                            'posts_per_page' => -1,
    ...
    <?php if ($price_perfect_section['show_section'] == 1) { ?>
        <div class="pricePerfect languagesPage">
            <div class="circle-translation-top">
                <p class="circle-trans-heading">
                    <?php echo __($price_perfect_section)['main_heading'] ?>
                </p>
                <p>
                    <?php echo __($price_perfect_section)['sub_heading'] ?>
                </p>
            </div>

            <div class="cards">
                <?php
                foreach ($price_perfect_section['plans'] as $value) {
                ?>

                    <div class="card">
                        <div class="cardTop">
                            <h2><?php echo $value['plan_name'] ?></h2>
                            <img src="<?php $value['plan_icon'] ?>" alt="">
                        </div>
                        <div class="price">
                            <p>from</p>
                            <h2>€<?php echo $value['plan_price'] ?></h2>
                            <p>/ Word</p>
                        </div>
                        <div class="cardBottom">
                            ...
                            <a href="<?php echo get_default_content($value['button_link'], site_url('get-a-quote')); ?>">
                                <button class="btn"><?php echo get_default_content($value['button_text'], "Get a Quote") ?></button>
                            </a>
                        </div>
            ...
            <a href="<?php echo get_default_content($price_perfect_section['cta_button_link'], site_url('get-a-quote')) ?>">
                <button class="more btn">
                    <?php echo get_default_content($price_perfect_section['cta_button_text'], "Get a Quote") ?>
                </button>
            </a>
        </div>
    <?php } ?>
    ...
    <?php if ($english_to_etc_translation_section['show_section'] == 1) { ?>
        <div class="englishToArabic languagesPage">
            <div class="englishToArabicContainer">
                <div class="circle-translation-top">
                    <p class="circle-trans-heading">
                        <?php echo __($english_to_etc_translation_section)['main_heading'] ?>
                    </p>
                    <div class="text"><?php echo __($english_to_etc_translation_section)['sub_heading'] ?></div>
                </div>
                <a href="<?php echo get_default_content($english_to_etc_translation_section['cta_button_link'], site_url('get-a-quote')) ?>">
                    <button class="more btn"><?php echo get_default_content($english_to_etc_translation_section['cta_button_text'], "Get a Quote") ?></button>
                </a>
            </div>
        </div>
    <?php } ?>
    ...
    <?php if ($translation_services_section['show_section'] == 1) { ?>
        <div class="arabicTranslation languagesPage circle-translation">
            <div class="circle-translation-top">
                <p class="circle-trans-heading"><?php echo __($translation_services_section)['main_heading'] ?></p>
                <div style="max-width: 100%; width: 100%; margin: 20px auto 20px; text-align:left" class="head-desc"><?php echo __($translation_services_section)['sub_heading'] ?></div>
            </div>
            <div class="cards">
                <?php
                foreach ($translation_services_section['services'] as $value) {
                    if (!empty($value['service_heading'])) {
                ?>
                        <div class="card">
                            <div class="cardTop">
                                <img src="<?php echo get_default_content($value['service_icon'], 'https://ct.sn66.me/wp-content/uploads/2023/12/manufacture-1.png') ?>" alt="">
                                <div class="text">
                                    <h2><?php echo __($value['service_heading']) ?></h2>
                                    <p ><?php echo  substr($value['service_description'], 0, strpos($value['service_description'], " ", 100)) . "..." ?></p>
                                </div>
                            </div>
                            <p><?php echo substr($value['service_description'],strpos($value['service_description'], " ", 100)) ?></p>
                        </div>
                <?php
                    }
                }
            ...
            <a href="<?php echo get_default_content($translation_services_section['cta_button_link'], site_url('get-a-quote')) ?>">
                <button style="margin-top : 40px;display: flex;" class="btn"><?php echo get_default_content($translation_services_section['cta_button_text'], "Get a Quote") ?></button>
            </a>
        </div>
    <?php } ?>
    ...
    <?php if ($translators_section['show_section'] == 1) {
    ?>
        <div class="circleTransArabTrans languagesPage">
            <div class="circleTransArabTransContainer">
                <div class="circle-translation-top">
                    <p class="circle-trans-heading"><?php echo __($translators_section)['main_heading'] ?></p>
                    <div style="max-width: 100%; width: 100%; margin: 20px auto 20px; text-align : left" class="text"><?php echo __($translators_section)['sub_heading'] ?></div>
                </div>
                <div class="cards">
                    <?php
                    foreach ($translators_section['benefits'] as $value) {
                        if ($value['benefit_heading_'] != "") {
                    ?>
                            <div class="card">
                                <img src="<?php echo get_default_content($value['benefit_icon'], 'https://ct.sn66.me/wp-content/uploads/2023/12/FastTurnaround.png') ?>" alt="">
                                <div class="text">
                                    <h2><?php echo __($value['benefit_heading_']) ?></h2>
                                    <p style="display: -webkit-box;-webkit-line-clamp: 5;overflow: hidden;-webkit-box-orient: vertical;"><?php echo __($value['benefit_description']) ?></p>
                                </div>
                            </div>
                    <?php
                        }
                ...
                <a style="margin: auto;" href="<?php echo get_default_content($translators_section['cta_button_link'], site_url('get-a-quote')) ?>">
                    <button style="display: flex;" class="btn"><?php echo get_default_content($translators_section['cta_button_text'], "Get a Quote") ?></button>
                </a>
            </div>
        </div>
    <?php } ?>
        ...
        <div class="pricingPage servicesPage SingleCTLanguage">
            <div class="pricing-section home-contain">
                <div class="pricing-top">
                    <p class="page-h2"><?php echo $pricing_plans_section['main_heading'] ?></p>
                ...
                <div class="pricing-card-container ">
                    ...
                    ?>
                        <div class="price-card basic-price-card <?php if ($recommended === 'yes') { ?> recommendedPriceCard <?php } ?>">
                            ...
                            <button><a href="<?php echo esc_url($post_id['quote_button_url']); ?>"><?php echo get_default_content($post_id['quote_button_text'], "Get a Quote") ?></a></button>
                        </div>
                    <?php
                    }
                    ?>
    ...
    <?php if ($need_more_info['show_section'] == 1) {
    ?>
        <div class="needForInfo CTLanguage">
            ...
            <div class="container">
                ...
                <div class="left">
                    <h2><?php echo __($need_more_info)['heading'] ?></h2>
                    <p><?php echo __($need_more_info)['description'] ?></p>
                </div>
                <div class="right">
                    <a href="<?php echo get_default_content($need_more_info['cta_button_link'], site_url('get-a-quote')) ?>">
                        <button class="btn"><?php echo get_default_content($need_more_info['cta_button_text'], "Get a Quote") ?></button>
                    </a>
                </div>
            </div>
        </div>
    ...
    <?php if ($where_to_start_section['show_section'] == 1) {
    ?>
        <div class="whereToStart englishToArabic languagesPage" style="background : white">
            <div class="englishToArabicContainer">
                <div class="circle-translation-top">
                    <p class="circle-trans-heading">
                        <?php echo __($where_to_start_section['heading']) ?>
                    </p>
                    <div class="text">
                        <?php echo __($where_to_start_section['description']) ?>
                    </div>
                </div>
                <a href="<?php echo get_default_content($where_to_start_section['cta_button_link'], site_url('get-a-quote')) ?>">
                    <button class="btn">
                        <?php echo get_default_content($where_to_start_section['cta_button_text'], "Get a Quote") ?>
                    </button>
                </a>
            </div>
    ...
    <?php if ($our_process_section['show_section'] == 1) {
    ?>
        <div class="translation-process languagesPage">

            <div class="translation-process-left">
                <p class="transation-process-heading">
                    <?php echo __($our_process_section['heading']) ?>
                </p>
                <p style="margin-bottom : 24px" class="translation-process-description"><?php echo __($our_process_section['description']) ?></p>
                <div class="translation-process-bottom">
                    <?php
                    $counter = 1;
                    $steps = $our_process_section['steps'];
                    foreach ($steps as $key => $step) {
                        if (!empty($step['step_heading'])) { ?>
                            <div class="translation-process-point">
                                <div class="point-number point-number-one" style="background: #F29111;">
                                    <span><?php echo __($step['step_number']) ?></span>
                                    <?php
                                    if ($counter < count($steps) - 2) { ?>
                                ...
                                <div class="right">
                                    <h2 style="color : #F29111"><?php echo __($step['step_heading']) ?></h2>
                                    <p><?php echo __($step['step_description']) ?></p>
                                </div>
                            </div>
                    <?php
                            $counter++;
                ...
                <a href="<?php echo get_default_content($our_process_section['cta_button_link'], site_url('get-a-quote')) ?>">
                    <button class="btn">
                        <?php echo get_default_content($our_process_section['cta_button_text'], "Get a Quote") ?>
                    </button>
                </a>
            </div>
        </div>
    ...
    <?php if ($etc_translation_services_section['show_section'] == 1) {
    ?>
        <div class="englishToArabic ArabTransServ languagesPage" style="background : white">
            <div class="englishToArabicContainer">
                <div class="circle-translation-top">
                    <p class="circle-trans-heading">
                        <?php echo __($etc_translation_services_section)['heading'] ?>
                    </p>
                    <div class="text">
                        <?php echo __($etc_translation_services_section)['description'] ?>
                    </div>
                </div>
                <a href="<?php echo get_default_content($etc_translation_services_section['cta_button_link'], site_url('get-a-quote')) ?>">
                    <button class="btn">
                        <?php echo __($etc_translation_services_section)['cta_button_text'] ?? "Get a Quote" ?>
                    </button>
                </a>
            </div>
    ...
    <?php if ($etc_translation_categories_section['show_section'] == 1) { ?>
        <div class="arabicTranslation languagesPage arabTranslationCategories">
            <div class="arabTranslationCategoriesContainer">
                <div class="circle-translation-top">
                    <p class="circle-trans-heading">
                        <?php echo __($etc_translation_categories_section)['heading'] ?>
                    </p>
                </div>
                <div class="cards">
                    <?php
                    foreach ($etc_translation_categories_section['categories'] as $value) {
                    ?>
                        <div class="card">
                            <div class="cardTop">
                                <img src="<?php echo $value['category_icon'] ?>" alt="">
                                <div class="text">
                                    <h2><?php echo $value['category_heading'] ?></h2>
                                    <p style="display: -webkit-box;-webkit-line-clamp: 3;overflow: hidden;-webkit-box-orient: vertical;"><?php echo __($value['category_description']) ?></p>
                                </div>
                            </div>
                            <p style="display: -webkit-box;-webkit-line-clamp: 4;overflow: hidden;-webkit-box-orient: vertical;"><?php echo $value['category_description'] ?></p>
                        </div>
                    <?php
                    }
                    ?>
                </div>
                <a href="<?php echo get_default_content($etc_translation_categories_section['cta_button_link'], site_url('get-a-quote')) ?>">
                    <button class="btn"><?php echo get_default_content($etc_translation_categories_section['cta_button_text'], "Get a Quote") ?></button>
                </a>
            </div>
        </div>
    <?php } ?>
    ...
    <?php if ($quick_guide_to_etc_translation_section['show_section'] == 1) { ?>
        <div class="translation-process languagesPage QuickGuide">
            <div class="translation-process-left">
                <div class="transation-process-heading">
                    <?php echo __($quick_guide_to_etc_translation_section)['heading'] ?>
                </div>
                <div style="margin-top: 32px; margin-bottom: 24px; width : 100%; <?php if ($quick_guide_to_etc_translation_section['side_image'] != "") { ?> display : flex; justify-content : space-between;<?php } ?>" class="translation-process-description">
                    <div class="text" <?php if ($quick_guide_to_etc_translation_section['side_image'] != "") { ?> style="width : 50%" <?php } ?>>
                        <?php echo __($quick_guide_to_etc_translation_section)['description'] ?>
                    </div>
                    <?php if ($quick_guide_to_etc_translation_section['side_image'] != "") {
                    ...
                    ?>
                        <div class="bg-image" style="position : relative">
                            <svg class="availabe-language-left-pic" xmlns="http://www.w3.org/2000/svg" width="526" height="441" viewBox="0 0 625 529" fill="none">
                                ...
                                <image id="image" preserveAspectRatio="xMidYMid slice" class="image__svg-image" width="100%" height="100%" clip-path="url(#mask)" xlink:href="<?php echo $quick_guide_to_etc_translation_section['side_image'] ?>" />
                ...
                <?php if ($quick_guide_to_etc_translation_section['steps']['step1']['step_number'] != "") { ?>
                    <div class="translation-process-bottom">
                        <?php if (!empty($quick_guide_to_etc_translation_section['steps']['step1']['step_description'])) { ?>
                            <div class="translation-process-point">
                                <div class="point-number point-number-one">
                                    <span><?php echo $quick_guide_to_etc_translation_section['steps']['step1']['step_number'] ?></span>
                                    <svg width="1" height="155" viewBox="0 0 1 155" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <line x1="0.5" y1="0.5" x2="0.499993" y2="154.5" stroke="#F29111" stroke-linecap="round" stroke-dasharray="3 3" />
                                    </svg>
                                </div>
                                <div class="right">
                                    <p><?php echo $quick_guide_to_etc_translation_section['steps']['step1']['step_description'] ?></p>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($quick_guide_to_etc_translation_section['steps']['step2']['step_description'])) { ?>
                            <div class="translation-process-point">
                                <div class="point-number point-number-two">
                                    <span><?php echo $quick_guide_to_etc_translation_section['steps']['step2']['step_number'] ?></span>
                                ...
                                <div class="right">
                                    <p><?php echo $quick_guide_to_etc_translation_section['steps']['step2']['step_description'] ?></p>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($quick_guide_to_etc_translation_section['steps']['step3']['step_description'])) { ?>
                            <div class="translation-process-point">
                                <div class="point-number point-number-three">
                                    <span><?php echo $quick_guide_to_etc_translation_section['steps']['step3']['step_number'] ?></span>
                                    <svg width="1" height="101" viewBox="0 0 1 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <line x1="0.5" y1="0.5" x2="0.499996" y2="100.5" stroke="#7267DB" stroke-linecap="round" stroke-dasharray="3 3" />
                                    </svg>
                                </div>
                                <div class="right">
                                    <p><?php echo $quick_guide_to_etc_translation_section['steps']['step3']['step_description'] ?></p>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if (!empty($quick_guide_to_etc_translation_section['steps']['step4']['step_description'])) { ?>
                            <div class="translation-process-point">
                                <div class="point-number point-number-three" style="background-color : #A4CF0E">
                                    <span><?php echo $quick_guide_to_etc_translation_section['steps']['step4']['step_number'] ?></span>

                                </div>
                                <div class="right">
                                    <p><?php echo $quick_guide_to_etc_translation_section['steps']['step4']['step_description'] ?></p>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                <?php } ?>
                <a href="<?php echo get_default_content($quick_guide_to_etc_translation_section['cta_button_link'], site_url('get-a-quote')) ?>">
                    <button class="btn">
                        <?php echo get_default_content($quick_guide_to_etc_translation_section['cta_button_text'], "Get a Quote") ?>
                    </button>
                </a>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            if(window.innerWidth <= 768){
                $('.pricePerfect.languagesPage .cards').slick({
                    dots: true,
                    infinite: false,
                    speed: 300,
                    slidesToShow: 2,
